...
Unix: `curl http://localhost:9000/api/counter/1`

Windows (PowerShell): `iwr http://localhost:9000/api/counter/1`
...
Unix: `curl -H "Content-Type: application/json" -X POST -d '{"@type": "IncrementCounter"}' http://localhost:9000/api/counter/1`

Windows (PowerShell): `iwr http://localhost:9000/api/counter/1 -Method 'POST' -Headers @{'Content-Type' = 'application/json'} -Body '{"@type": "IncrementCounter"}'`
